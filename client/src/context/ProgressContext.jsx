...
export const ProgressProvider = ({ children }) => {
    ...
    ws.onmessage = (event) => {
      try {
        ...
        setProgressList(prev => prev.map(item => {
          ...
          let updated = { ...item };
          // Deep clone the nested stages object to trigger state change correctly
  ...
  return (
    <ProgressContext.Provider value={{ progressList, addJobByUrl, addJobManually, clearJobProgress }}>
      {children}
